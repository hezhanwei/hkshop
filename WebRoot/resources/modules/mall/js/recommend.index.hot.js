...
function formatData(items) {
	...
	$.each(items, function(index, item) {
		...
		item._query = '<a href="'+BASE_URL+basePath+'/detail?recommendId=' + item.recommendId + '"  class="modal-detail"><i class="fa fa-search-plus" title="查看详情"></i></a>';
		item._action = '<a href="' + BASE_URL +basePath+ '/edit?recommendId=' + item.recommendId
