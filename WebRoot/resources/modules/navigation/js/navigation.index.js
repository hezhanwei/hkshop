...
function publishNavigation(id) {
	$.ajax({
    	type:'post',
        url:BASE_URL+'/navigation/publish',
...
function formatData(items) {
	$.each(items, function (index, item) {
    	...
    	item.operate = '<a href="'+BASE_URL+'/navigation/edit/?navigationId=' + item.navigationId + '" data-toggle="ajaxModal" class="operate-edit" title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;' + 
