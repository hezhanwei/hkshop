...
function doDeleteGroup(id) {
	...
	$.ajax({
    	type:'post',
        url:BASE_URL+'/trendPropertyGroup/delete',
        data:'ids=' + id,
        dataType:'json',
        timeout:60000,
...
function formatData(items) {
	$.each(items, function (index, item) {
    	...
    	item.operate = '<a href="'+BASE_URL+'/trendPropertyGroup/edit/?propertyGroupId=' + item.propertyGroupId + '" class="operate-edit load-content" title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;' + 
