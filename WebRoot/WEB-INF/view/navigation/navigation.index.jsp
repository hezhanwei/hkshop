    ...
    <header class="header bg-white b-b clearfix">
        <div class="row m-t-sm">
            <div class="col-sm-8 m-b-xs">
                ...
                <a href="${BASE_URL}/navigation/add" data-toggle="ajaxModal" class="btn btn-sm btn-default" id="modal_edit"><i class="fa fa-plus"></i> 添加</a>
            </div>
            
            <form action="${BASE_URL}/navigation/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/navigation/js/navigation.index.js"></script>