    ...
    <header class="header bg-white b-b clearfix">
        <div class="row m-t-sm">
            <div class="col-sm-8 m-b-xs">
                ...
                <a href="${BASE_URL}/goodsBrand/add" data-toggle="ajaxModal" class="btn btn-sm btn-default" id="modal_brand"><i class="fa fa-plus"></i> 添加</a>
            </div>
...
<script src="${STATIC_URL}/modules/goods/js/brand.index.js"></script>