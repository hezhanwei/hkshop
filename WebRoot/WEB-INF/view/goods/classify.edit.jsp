            ...
            <section class="scrollable wrapper w-f">
                <form class="form-horizontal" id="edit_form" action=<c:choose> <c:when test="${goodsClassify!=null}">"${BASE_URL}/goodsClassify/edit"</c:when><c:otherwise>"${BASE_URL}/goodsClassify/add"</c:otherwise></c:choose> method="post">
                    <div class="form-group">
                        <label for="classifyName" class="col-sm-3 control-label">分类名称</label>
                            <div class="col-sm-7">
                    ...
                    <div class="form-group">
                        <label for="type" class="col-sm-3 control-label"><font class="red">* </font>类型</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="type" name="type" value="${goodsClassify.type}" onkeydown="if(event.keyCode==13)return false;" placeholder="请输入" />
                             </div>
                      </div>

                    <div class="form-group">
                        <label for="isDelete" class="col-sm-3 control-label">是否删除</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="isDelete" name="isDelete" value="${goodsClassify.isDelete}" onkeydown="if(event.keyCode==13)return false;" placeholder="请输入" />
                             </div>
                      </div>
                    ...
                    <div class="form-group m-b-xs">
                        ...
                        <div class="col-sm-4">
                            ...
                            value="<fmt:formatDate value="${goodsClassify.ctime}" pattern="yyyy-MM-dd HH:mm"/>" placeholder="请选择创建时间时间" readonly="readonly"/>
                        </div>
                    </div>
