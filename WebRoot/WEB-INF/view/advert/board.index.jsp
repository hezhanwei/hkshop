            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-2 m-b-xs">
                        ...
                        <a href="${BASE_URL}/advertBoard/add" class="btn btn-sm btn-default" data-toggle="ajaxModal"><i class="fa fa-plus"></i> 添加</a>
                    </div>
                    <form action="${BASE_URL}/advertBoard/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/advert/js/board.index.js"></script>