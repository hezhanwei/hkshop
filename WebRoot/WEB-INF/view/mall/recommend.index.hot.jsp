            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/goodsRecommend/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加</a>
                    </div>
                    <form action="${BASE_URL}/goodsRecommend/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/mall/js/recommend.index.hot.js" type="text/javascript"></script>
<script>
	$(function(){
		var type = '${recommend_type}';
		if (type==='00') {
			$('#basePath').val('/goodsFirstRec');
		}else if(type==='11'){
			$('#basePath').val('/goodsSecondRec');
		}
		else if(type==='22'){
			$('#basePath').val('/secondSaleRec');
		}
		else if(type==='33'){
			$('#basePath').val('/goodsOnsale');
		}
	})
</script>