    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
                <form class="form-horizontal" id="edit_form" action="${BASE_URL}/adminUserGroup/add" method="post">
...
<script src="${STATIC_URL}/modules/admin/js/group.edit.js" type="text/javascript"></script>