...
<head>
	...
	<link rel="stylesheet" href="${STATIC_URL}/modules/admin/css/sign.css" type="text/css"/>
...
<section id="aui_iwrapper" class="animated fadeInUp aui-iwrapper">
    <section class="panel panel-default bg-white m-t-lg">
        ...
        <form action="${BASE_URL}/admin/sign/login" id="form_sign"  class="panel-body wrapper-lg" method="post" title="登录" data-validate="parsley">
            ...
            <div class="form-group">
                <img src="${BASE_URL}/admin/code" alt="点击换一张" id="vcodeimg" title="看不清楚，换一张" style="cursor:pointer;" onclick="this.src='${BASE_URL}/admin/code?t='+Math.random();" >
            </div> --%>
...
<script src="${STATIC_URL}/modules/admin/js/sign.js"></script>
</html>