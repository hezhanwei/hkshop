...
<link href="${STATIC_URL}/modules/coupon/css/category.index.css" rel="stylesheet" type="text/css"/>
        ...
        <section class="vbox">
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    ...
                    <form class="form-inline" action="${BASE_URL}/couponCategory/page" id="searchForm">
                    <div class="col-sm-10 m-b-xs text-right p-right">
                            ...
                            <div class="form-group">
                                <select id="isExchange" name="isExchange" class="form-control input-sm">
                                    <option value="">是否允许积分兑换</option>
